...
const Mainbilcomputer = require('../models/mainbilcomputer.model');
...
const registrarEquipo = async ( req, res = response ) => {
    ...
    try {
        ...
        const existIp = await Mainbilcomputer.findOne({
            where: {
                ip:body.ip
            }
        });
        ...
        const existSerieCandado = await Mainbilcomputer.findOne({
            where: {
        ...
        const computer = new Mainbilcomputer( body );
...
const obtenerEquipos = async ( req, res = response ) => {
    ...
    const computers = await Mainbilcomputer.findAll();
...
const countEquipos = async ( req, res = response) => {
    ...
    const cantidadEquipos = await Mainbilcomputer.count();
...
const obtenerEquipo = async ( req, res = response ) => {
    ...
    const computer = await Mainbilcomputer.findByPk(id);
    if ( !computer ) {
